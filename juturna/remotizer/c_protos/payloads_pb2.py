...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROTOENVELOPE']._serialized_end = 1352
    _globals['_COMPRESSEDPROTOPAYLOAD']._serialized_start = 1355
    _globals['_COMPRESSEDPROTOPAYLOAD']._serialized_end = 1496
